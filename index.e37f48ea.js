...
const controlQuiz = async function() {
    try {
        ...
        //Load question
        await _modelJs.loadMcq();
        //render question
        (0, _viewJsDefault.default).render(_modelJs.state.mcq);
        //Get Answer
        (0, _viewJsDefault.default).checkAnswer(_modelJs.state.mcq);
    } catch (err) {
        console.error(err);
    }
};
const init = function() {
    controlQuiz();
    (0, _viewJsDefault.default).addHandlerRender(controlQuiz);
};
init();

},{"./model.js":"Y4A21","./view.js":"ky8MP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadMcq", ()=>loadMcq);
...
const API_URL = "https://opentdb.com/api.php?amount=1&category=15&difficulty=easy&type=multiple";
...
class QuestionView {
    ...
    generateMarkup() {
        ...
        const markup = `
            <h6 class="quiz__question">${data.question}</h6>
    ...
    checkAnswer(data) {
        document.querySelectorAll(".options").forEach((li)=>{
            if (li.innerText === data[0].correctAnswer) li.classList.add("right");
        });
        this.parentEl.addEventListener("click", (e)=>{
            ...
            if (userAns === correct) {
                ...
                Number(++this._scoreEl.textContent);
            }
            if (userAns !== correct) {
                e.target.classList.add("wrong");
                document.querySelectorAll(".options").forEach((li)=>{
                    if (li.innerText === data[0].correctAnswer) li.classList.add("correct");
                });
            }
        });
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d8XZh","aenu9"], "aenu9", "parcelRequiref2cc")
